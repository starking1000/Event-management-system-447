    ...
    <section class="ServicesContainer">
        ...
        <div class="service-container">
            ...
            <div class="service-text">
                <h2><?php echo $rows['venue_name'];?></h2>
                <p><?php echo $rows['description'];?></p>
                <p>Location : <?php echo $rows['location'];?></p>
                <p>Capacity : <?php echo $rows['capacity'];?></p>
                <a href="./Forms/Createevent.php?venue_name=<?php echo $rows['venue_name']?>"><button> book now</button></a>
            </div>
        </div>
        <?php
        }
