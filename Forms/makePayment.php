...
<body>
    ...
    if(isset($_REQUEST['venue_name'])){
        ...
        $sql = "INSERT INTO payments VALUES (null,'$event', '$user_name','$venue_name','$amount')";
        $result = mysqli_query($conn, $sql);

        if ($result){
            echo " <div class='container'> Payment validated'<br/>
            <a href='../BrowseEvents.php'>Browse events</a>
            </div>";
        } else {
            echo " <div class='container'>Error saving data <br/>
            <a href='./makePayment.php'>Try again</a>
            </div>";
        }
    } else {
?>
 <div class="container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <input type="number" name="amount" id="amount" placeholder="Amount in Ksh">
